...
local skillsEQ = {
    ...
    ["Blitzcrank"] = { 1, 3, 1, 2, 1, 4, 1, 3, 1, 3, 4, 3, 3, 2, 2, 4, 2, 2, },
    ...
    ["Morgana"] = {
                    ["Mid"] = {2, 1, 2, 3, 2, 4, 2, 1, 2, 1, 4, 1, 1, 3, 3, 4, 3, 3, },
                    ["Mid2"] = {1, 2, 1, 3, 1, 4, 1, 2, 1, 2, 4, 2, 2, 3, 3, 4, 3, 3, },
    ...
    ["Volibear"] = { 3, 2, 2, 1, 2, 4, 2, 3, 2, 3, 4, 3, 3, 1, 1, 4, 3, 1 },
    ...
    ["Kindred"] = {2, 1, 3, 1, 1, 4, 1, 2, 1, 2, 4, 2, 2, 3, 3, 4, 3, 3},
    ["Illaoi"] = {3, 1, 2, 3, 1, 4, 3, 1, 3, 1, 4, 3, 1, 2, 2, 4, 2, 2},
    ["Jhin"] = {2, 1, 3, 2, 2, 4, 2, 1, 2, 1, 4, 1, 1, 3, 3, 4, 3, 3}
}

function skillsx.returnSkills()
  return skillsEQ[player.charName]
end
